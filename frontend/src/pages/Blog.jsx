...
const Blog = () => {
    const posts = [
        {
            title: 'Hiring Trends 2026: The Rise of AI in Recruitment',
            excerpt: 'How artificial intelligence is reshaping the way companies identify and attract top-tier talent in the modern era.',
            date: 'March 24, 2026',
            author: 'Hirealize Intel',
            category: 'Hiring Trends',
            image: '/blog/1.jpg'
        },
        {
            title: 'The Ultimate Resume Guide for Executives',
            excerpt: 'Mastering the art of professional branding. Learn how to craft a resume that commands a $200k+ salary.',
            date: 'March 20, 2026',
        ...
        {
            title: 'How to Scale Your Startup Team Fast',
            excerpt: 'Strategic advice for early-stage founders on building a core team that scales without losing culture.',
            date: 'March 15, 2026',
            author: 'Talent Lead',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-24 animate-fade-in-up">
              ...
              <h1 className="text-5xl md:text-7xl font-display font-bold text-white mb-6 tracking-tighter">
                  Intelligence <span className="bg-gradient-to-r from-orange-400 to-white bg-clip-text text-transparent italic">Feed</span>
              </h1>
          ...
          <div className="mt-32 p-12 lg:p-20 rounded-[3rem] bg-gradient-to-br from-white/[0.03] to-transparent border border-white/10 text-center relative overflow-hidden group hover:border-orange-500/30 transition-all duration-1000">
              ...
              <div className="relative z-10 max-w-2xl mx-auto space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 items-center justify-center p-2 bg-white/[0.02] border border-white/10 rounded-3xl backdrop-blur-md">
                      <input 
                        type="email" 
                      ...
                      />
                      <button className="group/btn relative w-full sm:w-auto px-10 py-5 bg-orange-600 text-white font-black uppercase tracking-[0.3em] overflow-hidden rounded-2xl transition-all hover:scale-[1.02] active:scale-95 text-[11px] shadow-2xl shadow-orange-600/20 shrink-0 flex items-center justify-center">
